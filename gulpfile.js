...
const path = {
    ...
    src: {
        ...
        vendorStyles:       "src/styles/vendor/*.css",
        img:                "src/img",
        svg:                "src/img/svg/**.svg",
...
// Сбор подключаемых библиотек js (отделно)
const includedJsBuild = () => {
    return src(
        [
...
const watchFiles = () => {
    ...
    watch(path.watch.styles, vendorCssBuild);
...
exports.default = series(clean, cacheBuild, phpBuild, vendorCssBuild, cssBuild, vendorJs, /*includedJsBuild, mainJsBuild,*/ resources, imagesDev, /*webpImages,*/ svgSprites, watchFiles);

exports.svg = series(clean, cacheBuild, phpBuild, svgPreparation, watchFiles);

exports.build = series(toProd, clean, cacheBuild, phpBuild, vendorCssBuild, cssBuild, libsJsBuild, mainJsBuild, resources, images, webpImages, svgSprites, watchFiles);